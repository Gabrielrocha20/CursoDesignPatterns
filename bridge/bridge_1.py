...
da dus implementação, de modo que as duas possam 
varias e evoluir independentemente.

Abstração é uma camada de alto nivel para algo
Geralmente, a abstração não faz nenhum trabalho
por conta propria , ela delega parte ou todo o
trabalho para a camada de implementação.

Relembrando: Adapter e um padrao de projeto estrutural
que tem a intençao de permitir que duas classes
que seria incompativeis trabalhem em conjunto
atrabes de um "adaptador"

Diferança (GoF pag. 208) - A diferença chave 
entre esses padrões esta nas suas intenções...
... O padrão Adapter faz as coisas funcionarem 
APÓS elas terem sido projetadas; o Bridge as faz
funcionart ANTES QUE existam...
"""
