...
sequencialmente, os elementos de um oobjeto
agregado sem expor sua representação sunjacente.
...
A ideia principal do padrão e retirar a responsabilidade
de acesso e percutso de uma coleção, delegando tais tarefas
