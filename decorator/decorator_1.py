"""
Decorator e um padrao de projeto estrutural que permite que voce
adicione novos comportamentos em objetos ao colocalos dentro de um "wrapper"
(decorador) de objetos.
Decoradores fornacem uma alternativa flexivel ao uso de subclasses
para extensao de funcionalidades

Decorator (padrao de projeto) != Decorator em python

Python decorator -> Um decorator e um callable que aceta outra funçao como
argumento (a função decorada). o decorator pode realizar algum processamento
com a função ou objeto invocavel
Do livro "Python Fluente", po Luciano Ramalho (pag. 223)
"""
