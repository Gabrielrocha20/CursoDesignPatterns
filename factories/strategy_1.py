"""
Strategy e um padrao de projeto comportamental que tem a intençao de deinir 
uma familia de algoritimos, encapsular cada uma delas e torna-las 
intercambiaveis Strategy permite que o algoritimo varie independentemente dos 
clientes que utilizam

principio do aberto/fechado (Open/Closed principle)
Entidades devem ser abertas para extensão, mas fechadas para modificaçao
"""
