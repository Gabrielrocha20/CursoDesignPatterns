...
de separar a construçao de um objeto complexo
...
e isso ja é possivel no Python sem este padrão

Feralmente o builder aceita o encadeamento de métodos
(method chaining)
"""
...
if __name__ == '__main__':
    ...
    user1 = user_director.with_age('Gabriel', 'Rocha', 20)
    user2 = user_director.with_address('Gabriel', 'Rocha', 'Dr.Thouzet')
    print(user1)
    print(user2)
