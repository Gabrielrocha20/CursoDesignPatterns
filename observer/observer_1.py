...
objetos, de maneira que quando um objeto muda de estado, todo os
seus dependentes são notificados e atualizados automaticamente.

Um observer e um objeto que gostaria de ser informado, um observable
(subject) é a entudade que gera as informaçoes
"""
